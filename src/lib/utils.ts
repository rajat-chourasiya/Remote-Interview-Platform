import { clsx, type ClassValue } from "clsx"; //This function takes a list of Interview documents and groups them into different categories (e.g., succeeded, failed, completed, upcoming) based on their status and startTime. This is very useful for displaying interviews in different sections of a dashboard.
